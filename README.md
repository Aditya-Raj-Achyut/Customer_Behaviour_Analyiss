...
1. **Data Extraction** — Raw dataset sourced from Kaggle (dataset no longer publicly available). File included in repo: [customer_shopping_behavior.csv](customer_shopping_behavior.csv)
